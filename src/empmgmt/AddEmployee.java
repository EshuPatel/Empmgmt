...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfname, tffname, tfaddress, tfphone, tfaadhar, tfemail, tfsalary, tfdesignation, tflname;
//JDateChooser dcdob;
...
//            String dob = ((JTextField) dcdob.getDateEditor().getUiComponent()).getText();
            ...
            try {
                ...
                String query = "insert into emp.employees values('"+name+"', '"+fname+"', '"+salary+"', '"+address+"', '"+phone+"', '"+email+"', '"+education+"', '"+designation+"', '"+aadhar+"', '"+empId+"')";
